...
export const AdminMessages = () => {
    ...
    async function submitResponseToQuestion(id:number, response:string) {
        ...
        if(authState && authState?.isAuthenticated && id !== null && response !== ''){
            const messsageAdminRequestModel: AdminMessageRequest = new AdminMessageRequest(id,response);
            const requestOptions = {
                method:'PUT',
                headers: {
                    Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
                ...
                body:JSON.stringify(messsageAdminRequestModel)
            };
    ...
    return (
        <div className='mt-3'>
            {messages.length > 0 ?
                ...
                :
                <h5>No pending Q/A   no question</h5>
