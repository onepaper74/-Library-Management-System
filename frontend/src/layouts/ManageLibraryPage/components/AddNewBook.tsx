...
export const AddNewBook = () => {
    ...
    function getBase64(file:any) {
        ...
        //a file reader lets our web application asynchronously read the contents of a file stored on the user's conputer using file or blob objects to specify the file or data to read
